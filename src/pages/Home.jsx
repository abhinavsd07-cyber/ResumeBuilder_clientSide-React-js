    ...
    <>
      <section id='bg1'>
        <div className="  d-flex align-items-center h-100 justify-content-center">
          <div className="box p-5 rounded-4 text-center ">
            <h3 className='text-light fw-semibold'>Designed to get hired.</h3>
            <h4 className='fs-5'>Your skills, your story, your next job — all in one.</h4>
            <Link to={'/resumeGenerator'}>
              <button className='btn btn-primary text-light mt-4' >Make your Resume</button>
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="row p-5 m-0">
          ...
          <div className="col-6">
            <div className="row m-2">
              <div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid1.png" alt="" className='rounded-3' />
              </div>
              <div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid7.png" alt="" className='rounded-3' />
              </div>
              <div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid2.png" alt="" className='rounded-3' />
              </div>
              <div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid3.png" alt="" className='rounded-3' />
              </div>
            </div>
            <div className="row m-2">
              <div className="col-3">
